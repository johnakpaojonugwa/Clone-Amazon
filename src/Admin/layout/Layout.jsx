...
function Layout() {
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <aside className="w-64 bg-[#022C22] text-white flex flex-col p-5 fixed top-0 self-start h-screen">
                ...
                <nav className="flex-1 space-y-3">
                    <NavLink
                        to=""
                        className={({ isActive }) =>
                        `flex items-center gap-3 py-2 px-3 hover:bg-teal-900 rounded
                        ${isActive ? "bg-teal-800" : "hover:bg-teal-900"}`
                        }>
                        ...
                        {dropdownOpen && (
                            <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg z-50">
                                <div className="px-4 py-4 text-sm text-gray-700 space-y-4 shadow-md">
                                    ...
                                    <p className="font-bold text-sm">
                                        Email:{" "}
                                        <span className="font-light">{MerchantUser?.email}</span>
                                    </p>
                                    <p className="font-bold text-sm">
                                        Store Name:{" "}
                                        <span className="font-light">
                                            {MerchantUser?.store_name}
                                        </span>
                                    </p>
                                </div>
                            </div>
